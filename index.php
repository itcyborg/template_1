...
?>
    <main class="main">
        ...
        <div class="container categories pt-6">
            <h2 class="title-lg text-center mb-4">Clickable links with images</h2><!-- End .title-lg text-center -->
        ...
        <div class="blog-posts pt-7 pb-7" style="background-color: #fafafa;">
            <div class="container">
                <h2 class="title-lg text-center mb-3 mb-md-4">More cards with clickable links and images</h2><!-- End .title-lg text-center -->
